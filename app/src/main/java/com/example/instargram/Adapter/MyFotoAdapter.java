...
public class MyFotoAdapter extends RecyclerView.Adapter<MyFotoAdapter.ImageViewHolder> {
    ...
    @NonNull
    @Override
    public MyFotoAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final MyFotoAdapter.ImageViewHolder holder, final int position) {
